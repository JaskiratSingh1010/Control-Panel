...
function setSlideTwoKpis(targetLtr,doneLtr,targetRealise,currentRealise,oihLtr,balLtr){
  ...
  /* Realise of the Done litres, under the Done Ltr figure, in the two ways asked for:
       rate  = ₹ per litre  — the SAME formula as the Actual Realise card
                              (sc2Realise: total line_total ÷ total litres)
  ...
  if(elDoneRealise){
    ...
    if(perL>0){
      ...
      elDoneRealise.title='Realise of the Done litres — ₹ per litre (the same figure as the Actual '
                         +'Realise card) and the money those litres earned';
    }else if((doneLtr||0)>0){
